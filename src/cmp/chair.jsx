...
const Chair = () => {
  ...
  const [ frame ] = useTrimesh(() => ({ type: "Static", args: frameArgs, position: [ -5, 245, 2 ], rotation: [ 0, Math.PI, 0 ]}), useRef())
  const [ basket ] = useTrimesh(() => ({ mass: 10, args: basketArgs, position: [ -5, 247.5, 2 ], rotation: [ 0, Math.PI, 0 ]}), useRef())
  const [ chainA ] = useBox(() => ({ mass: 2, args: [ 0.1, 0.42, 0.1 ], position: [ -5, 249.8, 2 ], rotation: [ 0, Math.PI, 0 ]}), useRef())
  const [ chainB ] = useBox(() => ({ mass: 2, args: [ 0.1, 0.42, 0.1 ], position: [ -5, 249.7, 2 ], rotation: [ 0, Math.PI, 0 ]}), useRef())
