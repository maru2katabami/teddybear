...
const SwingChair = () => {
  ...
  const [ frame ] = useTrimesh(() => ({ type: "Static", args: [ nodes.frame.geometry.attributes.position.array, nodes.frame.geometry.index.array ]}), useRef())
  const [ basket ] = useTrimesh(() => ({ mass: 10, args: [ nodes.basket.geometry.attributes.position.array, nodes.basket.geometry.index.array ], position: [ 0, 2.5, 0 ]}), useRef())
